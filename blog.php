...
<body>
	...
	<div class="container">
	<nav>
 <ul class="nav justify-content-end " style="font-weight: 600">
  ...
  <li class="nav-item p3">
    <a class="nav-link" href="blog.php" tabindex="-1" aria-disabled="true">Blog</a>
  </li>
</ul>
</nav>
</div>
  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        ...
        <blockquote>
          <p>Growing fast into a <strong>bolt of lightning</strong>. Be careful to check something Try not to lead her on</p>
        </blockquote>
...
<p>Hello Welcome to My Blog Page</p>
</body>
</html>